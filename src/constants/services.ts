import { Rocket, Globe, LineChart, Sparkles } from 'lucide-react';
...
export const services = [
  ...
  },
  {
    ...
    subtext: "Een unieke cursus voor businessgerichte IT'ers en ondernemers die AI willen inzetten om zonder technische voorkennis een idee of behoefte tot leven te brengen – sneller, efficiënter en concreter dan ooit tevoren.",
    features: [
      "Leer AI tools gebruiken voor prototyping en proof of concepts",
      "Ontdek hoe je effectief met AI communiceert",
      "Versnel je proces van idee naar werkende oplossing",
      "Hands-on oefeningen met de nieuwste AI tools"
    ],
    cta: "Let's learn!",
